...
#### O objetivo é estruturar, do zero, a base de dados e a aplicação web de apoio a um negóciio de **Impressão 3D**, cujo nome: **Nós 3D**, sob CNPJ da aluna: <Nome Aluno?>, ainda está em fase inicial e cuja a gestão de pedidos e clientes sob o momento do começo da elaboração do projeto, é feita de forma descentralizada,por exemplo: em conversas de WhatsApp, e-mails e planilhas de cálculo.

#### O projeto percorre todas as etapas de um projeto de banco de dados profissional:
...
#### * Levantar os requisitos do negócio junto à parceira (questionário e definição de personas).
#### * Elaborar o modelo conceitual (DER) e o modelo lógico do banco de Dados.
#### * Implementar o projeto físico *(Sript SQL)* com regras de integridade referencial definidas.
